...
int main()
{
	...
	for (int i = 1; i < size; i++) // loop will run for the number of elemennts in the first array    
	{
		temp = arr[i];
		bool flag = true;
	...
	cout << endl << endl << "The array after removing duplicates is: " << endl;

	for (int j = 0; j < size2; j++) // outputing the non-repeated elements
	{
